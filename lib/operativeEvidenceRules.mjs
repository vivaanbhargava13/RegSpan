...
function disposalElementMatches(elementId, value) {
  ...
  const coveredInformation = /\b(?:consumer information|customer information|customer records?|customer files?|consumer report information|covered information|client information|client files?|client records?|member data|account[- ]holder records?)\b/;
