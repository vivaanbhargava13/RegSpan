...
function writtenComplianceRecordElementMatches(elementId, value) {
  ...
  switch (elementId) {
    ...
    case "retention_accessibility":
      return /\b(?:retain(?:s|ed|ing)?|preserv(?:e|es|ed|ing)|retention period|(?:one|two|three|four|five|six|\d+) years?|easily accessible place|accessible storage)\b/.test(normalized);
    default:
      return null;
  }
}
