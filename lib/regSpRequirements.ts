...
export const REG_SP_REQUIREMENTS: RegSpRequirement[] = [
  ...
  defineRequirement({
    ...
    evidenceCriteria: {
      ...
      strongEvidence: "Vendor or service-provider policies/contracts require due diligence and monitoring, protection of customer information, and prompt breach notice to the firm.",
    ...
    coverageElements: [
      ...
      },
      {
        ...
        label: "Requires service providers to protect customer information",
        requiredForCovered: true,
        signals: [
