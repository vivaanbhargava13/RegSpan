...
export const REG_SP_REQUIREMENTS: RegSpRequirement[] = [
  ...
  },
  {
    ...
    actionSignals: ["notify", "notification", "notice", "affected customers", "breach notification"],
    partialSignals: ["notice", "notification", "customer information", "unauthorized use", "affected individuals"],
  ...
  },
  {
    ...
    actionSignals: ["preserve", "retain", "collect", "document", "chain of custody", "forensic"],
    partialSignals: ["logs", "evidence", "records", "forensic", "retention"],
  ...
  },
  {
    ...
    actionSignals: ["remediate", "remediation", "validate", "track", "test", "verify", "corrective action"],
    partialSignals: ["recovery", "restoration", "closure", "testing", "lessons learned"],
