...
export function Topbar({ session, workspaceName }: TopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-app-border bg-app-shell/85 backdrop-blur-xl">
      <div className="flex min-h-[72px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-10">
        <div className="min-w-0">
          <div className="flex items-center gap-2 text-xs font-medium text-app-subtle">
            <span>RegSpan</span>
