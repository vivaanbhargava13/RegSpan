...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  appPrimary:
    "bg-app-accent text-white shadow-[0_6px_16px_rgba(29,78,216,0.18)] hover:bg-app-accent-hover hover:shadow-[0_8px_22px_rgba(29,78,216,0.22)] focus-visible:outline-app-accent",
  appSecondary:
...
export function Button({
  ...
  const classes = [
    "inline-flex items-center justify-center rounded-xl font-semibold transition-all duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 active:translate-y-px disabled:cursor-not-allowed disabled:opacity-60 disabled:shadow-none",
